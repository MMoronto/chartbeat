                ...
                <div className='border-r-1 border-color m-4 pr-10'>
                  <div>
                    <p>
                      ...
                      <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3 text-xs'>48%</span>
                    </p>
                    <p className='text-gray-500 mt-1'>Budget</p>
                  </div>
                  <div className='mt-8'>
                    <p>
                      <span className='text-3xl font-semibold'>$36,000</span>
                    </p>
                    <p className='text-gray-500 mt-1'>Expense</p>
                  </div>

                  <div className='mt-5'>
                    <SparkLine  currentColor='blue' id='line-sparkline' type='Line' height='8-px' width='250px' data={SparklineAreaData} color='blue' />
                  </div>
                </div>
              </div>
